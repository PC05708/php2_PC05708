      ...
      <li class="nav-item nav-profile">
        <a href="#" class="nav-link">
          <div class="nav-profile-image">
            <img src="<?= _DIR_ASSETS ?>assets/images/faces/face1.jpg" alt="profile">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="users">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="<?= _WEB_ROOT . '/User/add' ?>">Thêm người dùng</a></li>
            <li class="nav-item"> <a class="nav-link" href="<?= _WEB_ROOT . '/User' ?>">Danh sách người dùng</a></li>
          </ul>
        </div>
      </li>
      <!-- Products -->
